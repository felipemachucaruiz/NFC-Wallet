...
export const eventsTable = pgTable("events", {
  ...
  cardReaderTopupFeePercent: numeric("card_reader_topup_fee_percent", { precision: 5, scale: 2 }).notNull().default("0"),
  appTopupFeePercent: numeric("app_topup_fee_percent", { precision: 5, scale: 2 }).notNull().default("0"),
  onlineTicketFeePercent: numeric("online_ticket_fee_percent", { precision: 5, scale: 2 }).notNull().default("0"),
