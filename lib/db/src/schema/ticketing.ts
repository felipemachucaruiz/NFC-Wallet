...
export const ticketTypesTable = pgTable("ticket_types", {
  ...
  serviceFeeType: varchar("service_fee_type", { length: 20 }).notNull().default("fixed"),
...
export const ticketsTable = pgTable("tickets", {
  ...
  attendeeDateOfBirth: varchar("attendee_date_of_birth", { length: 10 }),
  attendeeSex: varchar("attendee_sex", { length: 10 }),
  attendeeIdDocument: varchar("attendee_id_document", { length: 50 }),
