...
function mapApiToEventData(detail: ApiEventDetail): EventData {
  ...
  return {
    ...
    coverImage: resolveImageUrl(event.coverImageUrl, 2000),
    flyerImage: resolveImageUrl(event.flyerImageUrl, 1000),
    floorplanImage: venue?.floorplanImageUrl ? resolveImageUrl(venue.floorplanImageUrl, 1600) : "",
