...
function PuntosColombiaIcon({ className }: { className?: string }) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 89 36">
      <defs>
        <clipPath id="pc-clip">
          <rect width="88.87" height="36"/>
        </clipPath>
      </defs>
      <g clipPath="url(#pc-clip)">
        ...
        <path fill="currentColor" d="M36.47,4.43h-4.92v12.99h2.78v-3.99h2.13c2.93,0,4.86-1.76,4.86-4.49s-1.93-4.51-4.86-4.51h0ZM36.21,11.12h-1.88v-4.36h1.88c1.41,0,2.32.84,2.32,2.19s-.91,2.17-2.32,2.17Z"/>
        <path fill="currentColor" d="M48.87,12.99c0,1.6-.56,2.38-1.86,2.38s-1.86-.78-1.86-2.38v-5.1h-2.62v5.1c0,3.38,1.82,4.53,4.47,4.53s4.47-1.15,4.47-4.53v-5.1h-2.62v5.1h0Z"/>
        <path fill="currentColor" d="M58.21,7.77c-1.47,0-2.34.56-2.95,1.31l-.24-1.2h-2.28v9.54h2.62v-4.88c0-1.65.78-2.62,2.13-2.62s1.93.85,1.93,2.47v5.03h2.62v-5.29c0-3.27-1.76-4.36-3.82-4.36h0Z"/>
        <path fill="currentColor" d="M66.71,14.27v-4.18h2.19v-2.21h-2.19v-2.67h-2.62v2.67h-1.58v2.21h1.58v4.6c0,1.82.91,2.73,2.73,2.73h2.13v-2.21h-1.3c-.69,0-.95-.28-.95-.95Z"/>
        <path fill="currentColor" d="M74.41,17.61c-1.53,0-2.75-.45-3.67-1.35-.92-.89-1.38-2.08-1.38-3.55s.46-2.66,1.38-3.56c.92-.9,2.14-1.35,3.67-1.35s2.76.45,3.68,1.35c.92.9,1.38,2.09,1.38,3.56s-.46,2.67-1.38,3.56c-.92.89-2.15,1.34-3.68,1.34ZM74.41,15.47c.73,0,1.31-.25,1.75-.76.43-.51.65-1.17.65-1.99s-.22-1.48-.65-1.99c-.44-.51-1.02-.77-1.75-.77s-1.3.26-1.73.77c-.43.51-.64,1.17-.64,1.99s.21,1.48.64,1.99c.43.51,1,.76,1.73.76Z"/>
        <path fill="currentColor" d="M84.86,11.56c-1.37-.17-2.19-.24-2.19-.97,0-.61.67-.98,1.69-.98s1.78.46,1.86,1.23h2.51c-.13-1.95-1.89-3.08-4.45-3.08-2.45-.02-4.1,1.23-4.1,3.12s1.73,2.47,3.95,2.73c1.54.2,2.19.26,2.19,1.04,0,.67-.67,1.02-1.76,1.02-1.28,0-2-.58-2.1-1.41h-2.49c.11,2.04,1.91,3.29,4.57,3.29s4.34-1.21,4.34-3.1c0-2.15-1.82-2.65-4.01-2.88h0Z"/>
        <text x="30" y="34" fontSize="9" fill="currentColor" fontFamily="Arial, Helvetica, sans-serif" fontWeight="600">Colombia</text>
      </g>
    </svg>
  );
}
