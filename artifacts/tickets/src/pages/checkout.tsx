              ...
              <div className="space-y-2 mb-4">
                {methods.map((m) => (
                  <button
                    ...
                    disabled={processing}
                  >
                    {m.id === "nequi" ? <NequiIcon className="w-5 h-5" /> : m.id === "bancolombia_transfer" ? <BancolombiaIcon className="w-5 h-5" /> : m.id === "daviplata" ? <DaviplataIcon className="h-4 w-auto" /> : m.id === "puntoscolombia" ? <PuntosColombiaIcon className="h-4 w-auto" /> : m.icon ? <m.icon className="w-5 h-5" /> : null}
