...
const styles = StyleSheet.create({
  ...
  quickLinks: { gap: 8 },
  quickLinkBtn: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 14, paddingHorizontal: 16, borderRadius: 12 },
  quickLinkText: { fontSize: 14, fontFamily: "Inter_600SemiBold" },
