...
const REFUND_METHODS: {
  ...
  { value: "cash", icon: "dollar-sign", labelKey: "bank.refundMethodCash", needsAccount: false },
  { value: "nequi", icon: "smartphone", labelKey: "bank.refundMethodNequi", needsAccount: true },
  { value: "bancolombia", icon: "home", labelKey: "bank.refundMethodBancolombia", needsAccount: true },
  { value: "other", icon: "more-horizontal", labelKey: "bank.refundMethodOther", needsAccount: false },
];

export default function AttendeeRefundRequestScreen() {
  ...
  const handleSubmit = () => {
    Alert.alert(
      t("attendeeRefund.confirmTitle"),
      t("attendeeRefund.confirmMessage"),
      [
    ...
    return (
      <View style={[styles.center, { backgroundColor: C.background }]}>
        ...
        <Text style={[styles.successTitle, { color: C.text }]}>
          {t("attendeeRefund.successTitle")}
        </Text>
        <Text style={[styles.successSubtitle, { color: C.textSecondary }]}>
          {t("attendeeRefund.successMessage")}
        </Text>
        <Button
          title={t("common.back")}
          onPress={() => router.back()}
  ...
  return (
    ...
    >
      <View style={styles.headerRow}>
        ...
        <Text style={[styles.pageTitle, { color: C.text }]}>{t("attendeeRefund.title")}</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      <Card>
        <View style={styles.infoRow}>
          ...
          <Text style={[styles.infoText, { color: C.textSecondary }]}>
            {t("attendeeRefund.pendingInfo")}
          </Text>
        </View>
      </Card>

      <Button
        title={t("attendeeRefund.submit")}
...
const styles = StyleSheet.create({
  ...
  textInput: { borderWidth: 1, borderRadius: 12, padding: 14, fontSize: 15, fontFamily: "Inter_400Regular", minHeight: 48 },
