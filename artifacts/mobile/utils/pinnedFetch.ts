 ...
 * All Let's Encrypt-issued leaf certs on prod.tapee.app and
 * attendee.tapee.app chain through this root, so the pin survives
 * automatic 90-day leaf cert renewals without any app update.
 *
...
const PINNED_DOMAINS = ["prod.tapee.app", "attendee.tapee.app"];
