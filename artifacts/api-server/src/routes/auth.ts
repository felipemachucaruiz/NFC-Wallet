...
function buildStaffPasswordResetEmail(opts: { firstName: string | null; resetUrl: string }): { subject: string; htmlContent: string; textContent: string } {
  ...
  const htmlContent = `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head><body style="font-family:Arial,sans-serif;background:#0d1117;color:#e6edf3;margin:0;padding:0;"><div style="max-width:480px;margin:40px auto;background:#161b22;border-radius:12px;overflow:hidden;border:1px solid #30363d;"><div style="background:linear-gradient(135deg,#0d1117,#111827);padding:32px 32px 24px;text-align:center;"><h1 style="color:#00f1ff;font-size:28px;margin:0 0 8px;">Tapee</h1><p style="color:#8b949e;margin:0;font-size:14px;">Portal de Staff</p></div><div style="padding:32px;"><h2 style="color:#e6edf3;font-size:20px;margin:0 0 16px;">Restablecer contraseña</h2><p style="color:#8b949e;margin:0 0 24px;">${greeting} recibimos una solicitud para restablecer tu contraseña de cuenta de Staff en Tapee. Haz clic en el botón de abajo para crear una nueva.</p><div style="text-align:center;margin:24px 0;"><a href="${opts.resetUrl}" style="display:inline-block;background:#00f1ff;color:#0d1117;font-weight:bold;font-size:16px;padding:14px 32px;border-radius:8px;text-decoration:none;">Restablecer Contraseña</a></div><p style="color:#6e7681;font-size:13px;margin:24px 0 0;">Este enlace expira en 1 hora. Si no solicitaste un cambio de contraseña, puedes ignorar este correo.</p></div><div style="padding:16px 32px;background:#0d1117;text-align:center;border-top:1px solid #30363d;"><p style="color:#484f58;font-size:12px;margin:0;">&copy; Tapee &middot; Eventos cashless</p></div></div></body></html>`;
