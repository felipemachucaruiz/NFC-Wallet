...
import { useTicketPaymentStatus } from "@/hooks/useEventsApi";
  ...
  return (
    <View style={[styles.container, { backgroundColor: C.background }]}>
      ...
      >
        ...
        <Text style={[styles.pageTitle, { color: C.text }]}>{t("tickets.paymentStatus")}</Text>
        <View style={{ width: 30 }} />
      </View>
      ...
      <View style={[styles.content, { paddingBottom: insets.bottom + 24 }]}>
        ...
        {status === "success" && confirmedTickets && confirmedTickets.length > 0 && (
