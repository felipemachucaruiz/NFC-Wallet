  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">View all event transactions.</p>
      </div>
        ...
        <Table>
          ...
          <TableBody>
            {isLoading ? (
              ...
              <TableRow><TableCell colSpan={8} className="text-center py-8 text-muted-foreground">No event assigned.</TableCell></TableRow>
          ...
          {selected && (
            <div className="space-y-4 text-sm">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <p className="text-muted-foreground text-xs uppercase tracking-wider mb-1">Gross</p>
                  <p className="font-mono font-bold">${selected.grossAmountCop.toLocaleString()}</p>
                </div>
                <div>
                  <p className="text-muted-foreground text-xs uppercase tracking-wider mb-1">Commission</p>
                  <p className="font-mono">${selected.commissionAmountCop.toLocaleString()}</p>
                </div>
                <div>
                  <p className="text-muted-foreground text-xs uppercase tracking-wider mb-1">Net</p>
              ...
              {selected.items && selected.items.length > 0 && (
                <div>
                  <p className="text-muted-foreground text-xs uppercase tracking-wider mb-2">Line Items</p>
